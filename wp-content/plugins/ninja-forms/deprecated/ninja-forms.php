...
class Ninja_Forms {
    ...
    public function get_plugin_settings() {
      ...
      $settings['req_div_label'] = isset ( $settings['req_div_label'] ) ? $settings['req_div_label'] : sprintf( __( 'Los campos marcados %s*%s son requeridos', 'ninja-forms' ), '<span class="ninja-forms-req-symbol">','</span>' );
